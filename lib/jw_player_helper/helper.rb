  ...
  module Helper
    ...
    def video_player(flashvars, attributes = {} , params = {})
      ...
      result = %Q{<script type="text/javascript">
                    ...
                    swfobject.embedSWF('/swf/new_player.swf','#{attributes[:id]}','#{attributes[:width]}','#{attributes[:height]}','9','false', flashvars_#{attributes[:id]}, params_#{attributes[:id]}, attributes_#{attributes[:id]})
